...
namespace spacebattletest
{
    ...
    public partial class КосмическоеПередвижениеFeature : object, Xunit.IClassFixture<КосмическоеПередвижениеFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public КосмическоеПередвижениеFeature(КосмическоеПередвижениеFeature.FixtureData fixtureData, spacebattletest_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-ru"), "", "Космическое передвижение", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Космическое передвижение")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                КосмическоеПередвижениеFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                КосмическоеПередвижениеFeature.FeatureTearDown();
            }
        }
    }
}
